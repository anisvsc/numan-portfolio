...
const CustomSpotify = () => {
  ...
  return (
    <div className="bg-black p-4 rounded-lg shadow-lg flex items-center">
      ...
      {currentTrack ? (
        <>
          ...
          <div className="flex flex-col ml-4">
            <h3 className="text-white font-semibold text-lg">{currentTrack.name}</h3>
            <p className="text-gray-300">by {currentTrack.artist['#text']}</p>
            <p className="text-gray-400">on {currentTrack.album['#text']}</p>
          </div>
        </>
      ) : (
